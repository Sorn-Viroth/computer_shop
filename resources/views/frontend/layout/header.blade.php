                      ...
                      <div class="header-ctn">
                          ...
                          <div class="dropdown">
                              ...
                              {{-- <div class="cart-dropdown">
                                  ...
                                  <div class="cart-btns">
                                      ...
                                      <a href="{{ url('/checkout') }}">Checkout
                                          <i sclass="fa fa-arrow-circle-right"></i></a>
                                  </div>
                              </div> --}}
                              ...
                              <div class="cart-dropdown">
                                  <div class="cart-list">
                                      @if (session('cart'))
                                          @foreach (session('cart') as $id => $details)
                                              <div class="product-widget">
                                                  {{-- <div class="product-img">
                                                      <img src="{{ asset('frontend/img/product0' . $id . '.png') }}"
                                                          alt="">
                                                  </div> --}}
                                                  <div class="product-body">
                                  ...
                                  <div class="cart-summary">
                                      <small>{{ count(session('cart', [])) }} Item(s) selected</small>
                                      <h5>SUBTOTAL:
                                          ${{ array_reduce(session('cart', []),function ($carry, $item) {return $carry + $item['price'] * $item['quantity'];},0) }}
                                      </h5>
                                  </div>
