                    ...
                    <div class="aside">
                        ...
                        <div class="product-widget">
                            <div class="product-img">
                                <img src="{{ asset('frontend/img/a-1.jpg') }}" alt="">
                            </div>
                        ...
                        <div class="product-widget">
                            <div class="product-img">
                                <img src="{{ asset('frontend/img/a-2.jpg') }}" alt="">
                            </div>
                            <div class="product-body">
                                <p class="product-category">Category</p>
                                <h3 class="product-name"><a href="#">product name goes here</a></h3>
                        ...
                        <div class="product-widget">
                            <div class="product-img">
                                <img src="{{ asset('frontend/img/a-3.jpg') }}" alt="">
                            </div>
                            <div class="product-body">
                                <p class="product-category">Category</p>
                                <h3 class="product-name"><a href="#">product name goes here</a></h3>
                ...
                <div id="store" class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-6">
                            ...
                            <div class="product">
                                <div class="product-img">
                                    <img src="{{ asset('frontend/img/a-4.jpg') }}" alt="">
                                </div>
                                <div class="product-body">
                                    <h3 class="product-name">
                                        <a href="#">ORICO MC-U111P 11-in-1 Multifunctional
                                            Type-C Adapter PD 3.0 5-20V/100W MAX</a>
                                    </h3>
                                ...
                                <div class="add-to-cart">
                                    <form action="{{ route('cart.add') }}" method="POST">
                                        ...
                                        <input type="hidden" name="product_name" value="ORICO MC-U111P 11-in-1 ">
