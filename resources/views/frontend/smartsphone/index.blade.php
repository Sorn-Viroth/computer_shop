                    ...
                    <div class="aside">
                        ...
                        <div class="product-widget">
                            <div class="product-img">
                                <img src="{{ asset('frontend/img/iphone -16pm.png') }}" alt="">
                            </div>
                        ...
                        <div class="product-widget">
                            <div class="product-img">
                                <img src="{{ asset('frontend/img/iphone-15pm.png') }}" alt="">
                            </div>
                            <div class="product-body">
                                <p class="product-category">Category</p>
                                <h3 class="product-name"><a href="#">product name goes here</a></h3>
                        ...
                        <div class="product-widget">
                            <div class="product-img">
                                <img src="{{ asset('frontend/img/iphone-16plus.png') }}" alt="">
                            </div>
                            <div class="product-body">
                                <p class="product-category">Category</p>
                                <h3 class="product-name"><a href="#">product name goes here</a></h3>
                ...
                <div id="store" class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-6">
                            <div class="product">
                                <div class="product-img">
                                    <img src="{{ asset('frontend/img/iphone-16pro.png') }}" alt="">
                                </div>
                                <div class="product-body">
                                    <h3 class="product-name">
                        ...
                        <div class="col-md-4 col-xs-6">
                            ...
                            <div class="product">
                                <div class="product-img">
                                    <img src="{{ asset('frontend/img/iphone-15pm(black).png') }}" alt="">
                                </div>
                                <div class="product-body">
                                    <h3 class="product-name">
                                        <a href="#">Iphone 15 Pro Max</a>
                                    </h3>
                                    <h4 class="product-price">$700.00 <del class="product-old-price">$950.00</del></h4>
                                    <div class="product-rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                        ...
                        <div class="col-md-4 col-xs-6">
                            ...
                            <div class="product">
                                <div class="product-img">
                                    <img src="{{ asset('frontend/img/huaweimatex6.png') }}" alt="">
                                </div>
                                <div class="product-body">
                                    <h3 class="product-name">
                                        <a href="#">Huawei Mate X6</a>
                                    </h3>
                                    <h4 class="product-price">$3500.00 <del class="product-old-price">$950.00</del></h4>
                                    <div class="product-rating">
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                        <i class="fa fa-star"></i>
                                ...
                                <div class="add-to-cart">
                                    <form action="{{ route('cart.add') }}" method="POST">
                                        ...
                                        <input type="hidden" name="product_name" value="Huawei Mate X6">
